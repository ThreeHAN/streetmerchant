...
const notifications = {
	...
	discord: {
		...
		notifyGroupSeries: {
			...
			'3080_combo': envOrArray(process.env.DISCORD_NOTIFY_GROUP_3080_COMBO),
			...
			tomahawk: envOrArray(process.env.DISCORD_NOTIFY_GROUP_TOMAHAWK),
...
const store = {
	...
	maxPrice: {
		series: {
			...
			'3080_combo': envOrNumber(process.env.MAX_PRICE_SERIES_3080_COMBO),
			...
			tomahawk: envOrNumber(process.env.MAX_PRICE_SERIES_X570_TOMAHAWK),
